...
router.get('/memories', (req, res) => {
  try {
    ...
    switch (sort) {
      case 'time':
        memories.sort((a, b) => new Date(b.mtime) - new Date(a.mtime));
        break;
      case 'time-asc':
        memories.sort((a, b) => new Date(a.mtime) - new Date(b.mtime));
        break;
      case 'created':
        memories.sort((a, b) => new Date(b.birthtime) - new Date(a.birthtime));
        break;
      case 'name':
      default:
